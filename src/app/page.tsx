...
import { GraduationCap, BriefcaseIcon as Briefcase, DownloadIcon} from 'lucide-react'
  ...
  return (
    <li className="flex gap-4">
      ...
      <div className="flex flex-auto flex-wrap gap-x-2">
        <span className="flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100">
          {role.organization}
        </span>
        <span
